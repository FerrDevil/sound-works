...
export default async function Header() {
 ...
 const session = await getSession() 
  ...
  return (
    <header className="fixed left-0 right-0 bottom-0 md:w-(--header-width) md:border-r-1 md:border-(--secondary-accent-color) md:mx-auto md:right-auto md:top-0 gap-3 grid bg-[#0a0a0a] z-999 isolate">
      <MusicPlayerView/>
        <nav className="flex max-md:justify-between px-10 md:px-0 py-4 md:py-4  md:gap-4 md:flex md:flex-col">
          <ul className="contents">
            <li >
              <Link href={"/"} className="flex flex-col gap-1 items-center">
                <svg  width={36} height={36}  viewBox="0 0 45 50"  fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect className="fill-[#A38F7B]" x="16.1347" y="0.0389633" width="9.99221" height="49.961" />
                  <path className="fill-[#6E6E77]" d="M0.902283 1.46813L31.2731 1.46813L45 9.01794V10.0475V11.077L31.2731 18.6268H0.902283L0.902283 1.46813Z" />
            ...
            <li >
              <Link  href={"/explore"} className="flex flex-col gap-1 items-center">
                <svg className="fill-white" width={36} height={36} viewBox="0 0 24 24"  fill="none" xmlns="http://www.w3.org/2000/svg">
