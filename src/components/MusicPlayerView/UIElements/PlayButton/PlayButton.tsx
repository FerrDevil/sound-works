...
export default function PlayButton() {
    ...
    return (
        <button className="cursor-pointer" onClick={() => dispatchMusicPlayerProperties({type: ACTION_TYPES.SET_MUSIC_STATE, payload: {state: musicPlayerProperties.settings.state === "playing"? "paused" : "playing"}})  }>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    {
                        musicPlayerProperties.settings.state === "playing" ?
                            <path d="M13.3333 9.53674e-07V37H3V9.53674e-07H13.3333ZM34 9.53674e-07V37H23.6667V9.53674e-07H34Z" fill="white"/> 
                        :
                        musicPlayerProperties.settings.state === "paused"?
